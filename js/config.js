...
const SUPABASE_URL = 'https://ccjnnfownpqrbbmjyulp.supabase.co';
const SUPABASE_KEY = 'sb_publishable_RJYiNHY4QquFzbhQ_vhK5g_odooZO65'; // publishable key (ปลอดภัยที่จะอยู่ในหน้าเว็บ)
